 ...
 */
        ...
        var Ct = function(t) {
            ...
            q(t, "__ob__", this),
            Array.isArray(t))
                ? ((B ? $t : At)(t, _t, bt), this.observeArray(t))
                : this.walk(t);
        };
        function $t(t, e, n) {
            t.__proto__ = e;
        ...
        function je() {
            ...
            for (
                ...
                (e = (t = $e[Ee]).id), (ke[e] = null), t.run();
            var n = Ae.slice(),
                r = $e.slice();
            (Ee = $e.length = Ae.length = 0),
                (ke = {}),
                (Oe = Se = !1),
                (function(t) {
                    for (var e = 0; e < t.length; e++)
                ...
                (t.prototype.$on = function(t, n) {
                    ...
                    (t.prototype.$emit = function(t) {
                        ...
                        if (e) {
                            e = e.length > 1 ? O(e) : e;
                            for (
                                var n = O(arguments, 1), r = 0, o = e.length;
                                r < o;
                                r++
                            )
                                try {
        ...
        function Lo(t) {
            if (Array.isArray(t)) return t.map(Lo);
            if (t && "object" == typeof t) {
                var e = {};
                for (var n in t) e[n] = Lo(t[n]);
                return e;
            }
            return t;
        }
        ...
        function Do(t, e) {
            return e === Mo
                ...
                : !!e &&
                      (t.path && e.path
                          ? t.path.replace(Ro, "") === e.path.replace(Ro, "") &&
                            t.hash === e.hash &&
                            Uo(t.query, e.query)
                          : !(!t.name || !e.name) &&
                            (t.name === e.name &&
        ...
        var Vo,
            ...
            Ho = {
                ...
                render: function(t) {
                    ...
                    var m = function(t) {
                            Bo(t) && (e.replace ? n.replace(i) : n.push(i));
                        },
                        y = { click: Bo };
                    ...
                    if ("a" === this.tag) (g.on = y), (g.attrs = { href: s });
                        ...
                        if (_) {
                            _.isStatic = !1;
                            var b = Vo.util.extend;
                            ((_.data = b({}, _.data)).on = y),
        ...
        function zo(t) {
            if (!zo.installed || Vo !== t) {
                ...
                t.mixin({
                    ...
                    t.component("router-view", Ao),
                    t.component("router-link", Ho);
                ...
                for (
                    ...
                    if ("string" != typeof c) {
                        ...
                        if (Go(f)) {
                            ...
                            if (
                                ((u = c.asterisk ? oi(f) : a(f)), !e[s].test(u))
                            )
                                throw new TypeError(
                                    'Expected "' +
                                        c.name +
        ...
        (Jo.parse = Qo),
            (Jo.compile = Yo),
            (Jo.tokensToFunction = Zo),
            (Jo.tokensToRegExp = ti);
        var pi = Object.create(null);
        function di(t, e, n) {
            try {
                return (pi[t] || (pi[t] = Jo.compile(t)))(e || {}, {
                    pretty: !0
                });
            } catch (t) {
                return "";
        ...
        function vi(t, e, n, r) {
            ...
            if (!o.path && o.params && e) {
                (o = mi({}, o))._normalized = !0;
                var i = mi(mi({}, e.params), o.params);
        ...
        function yi(t, e) {
            ...
            function s(t, n) {
                var r = t.redirect,
                    o = "function" == typeof r ? r(Po(t, n, null, e)) : r;
                if (
        ...
        function $i(t) {
            return {
                x: Ai(t.x) ? t.x : window.pageXOffset,
                y: Ai(t.y) ? t.y : window.pageYOffset
            };
        }
        function Ai(t) {
        ...
        function qi(t, e, n, r) {
            var o = Mi(t, function(t, r, o, i) {
                var a = (function(t, e) {
                    "function" != typeof t && (t = Vo.extend(t));
                    return t.options[e];
                })(t, e);
                if (a)
        ...
        (Vi.prototype.listen = function(t) {
            this.cb = t;
        }),
            ...
            (Vi.prototype.transitionTo = function(t, e, n) {
                var r = this,
            ...
            (Vi.prototype.confirmTransition = function(t, e, n) {
                var r = this,
                    o = this.current,
                    i = function(t) {
                        $o(t) &&
                ...
                if (Do(t, o) && t.matched.length === o.matched.length)
                ...
                var a = (function(t, e) {
                    ...
                    f = [].concat(
                        (function(t) {
                            return qi(t, "beforeRouteLeave", Fi, !0);
                        })(c),
                        this.router.beforeHooks,
                        (function(t) {
                            return qi(t, "beforeRouteUpdate", Fi);
                        })(s),
                        u.map(function(t) {
                ...
                Pi(f, l, function() {
                    ...
                    Pi(
                        (function(t, e, n) {
                            return qi(t, "beforeRouteEnter", function(
                                t,
                                r,
                                o,
                                i
            ...
            (Vi.prototype.updateRoute = function(t) {
                var e = this.current;
                (this.current = t),
                    this.cb && this.cb(t),
        ...
        var Hi = (function(t) {
            ...
            return (
                ...
                (e.prototype.ensureURL = function(t) {
                    if (Bi(this.base) !== this.current.fullPath) {
                ...
                t.call(this, e, n),
                    (r &&
                        (function(t) {
                            ...
                            if (!/^\/#/.test(e))
                                return (
                                    window.location.replace(Xo(t + "/#" + e)),
                                    !0
                                );
                        })(this.base)) ||
                        Wi();
        ...
        function Gi(t) {
            Oi ? Ii(Xi(t)) : (window.location.hash = t);
        }
        function Ji(t) {
            Oi ? Ri(Xi(t)) : window.location.replace(Xi(t));
        }
        var Qi = (function(t) {
                function e(e, n) {
            ...
            Yi = function(t) {
                void 0 === t && (t = {}),
                    ...
                    (this.resolveHooks = []),
                    (this.afterHooks = []),
                    (this.matcher = yi(t.routes || [], this));
                var e = t.mode || "hash";
                switch (
                    ((this.fallback =
                        "history" === e && !Oi && !1 !== t.fallback),
                    ...
                    case "history":
                        this.history = new Hi(this, t.base);
                        break;
                    case "hash":
        ...
        (Yi.prototype.match = function(t, e, n) {
            ...
            (Yi.prototype.init = function(t) {
                ...
                if ((this.apps.push(t), !this.app)) {
                    this.app = t;
                    var n = this.history;
                    if (n instanceof Hi) n.transitionTo(n.getCurrentLocation());
        ...
        var oa = _o(
            ...
            function() {
                ...
                return (t._self._c || e)(
                    "div",
                    { staticClass: "tmn-container" },
                    [
                        t._ssrNode(
                            '<div class="row"><div class="tmn-col-6-m"><form><div class="row"><div class="tmn-col-12-m"><div class="login-panel"><h3>Login</h3></div></div></div> <div class="row"><div class="tmn-col-12-m"><input type="text" name="username" placeholder="Email/Username" autofocus="autofocus" required="required"' +
                                t._ssrClass("tmn-input", [t.emailSuccess]) +
                                "> <span><i" +
                                t._ssrClass(null, [t.emailIcon]) +
                                '></i></span></div></div> <div class="row"><div class="tmn-col-12-m"><input type="password" name="password" placeholder="Password" pattern=".{6,25}" required="required"' +
                                t._ssrClass("tmn-input", [t.passwordSuccess]) +
                                "> <span><i" +
                                t._ssrClass(null, [t.passwordIcon]) +
                                '></i></span></div></div> <div class="row"><div class="tmn-col-12-m">' +
                                (t.errorMessage
                                    ? '<span class="error">' +
                                ...
                                ' class="tmn-btn">Sign In</button></div></div></form></div></div>'
                        )
                    ]
                );
            },
        ...
        oa.options.__file = "Login.vue";
        var ia = _o(
            {
                name: "Landing",
                components: { Login: oa.exports },
                data: function() {
                    return { errorMessage: "" };
                },
                methods: {
            ...
            return new Promise(function(e, n) {
                ...
                i.push(t),
                    i.onReady(function() {
                        ...
                        console.log(t), t.length || n({ code: 404 }), e(o);
                    }, n);
            });
        };
    }
