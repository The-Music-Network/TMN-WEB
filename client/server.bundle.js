 ...
 */
    ...
    var Ct = function(t) {
      ...
      B(t, "__ob__", this),
      Array.isArray(t))
        ? ((H ? At : kt)(t, _t, bt), this.observeArray(t))
        : this.walk(t);
    };
    function At(t, e, n) {
      t.__proto__ = e;
        ...
        e.computed &&
          (function(t, e) {
            ...
            for (var o in e) {
              ...
              0, r || (n[o] = new Ie(t, a || j, j, Me)), o in t || Ne(t, o, i);
            }
          })(t, e.computed),
        e.watch &&
          e.watch !== Z &&
    ...
    function Ne(t, e, n) {
      var r = !nt();
      "function" == typeof n
        ? ((Re.get = r ? Ue(e) : n), (Re.set = j))
        : ((Re.get = n.get ? (r && !1 !== n.cache ? Ue(e) : n.get) : j),
    ...
    function Vr(t, e) {
      ...
      return (
                ...
                : 0),
        {
          ...
          timeout: f,
          propCount: l,
          hasTransform: n === jr && Br.test(r[Ir + "Property"])
        }
      );
    }
    function Fr(t, e) {
        ...
        if (!O || w || "" === w) {
          ...
          var N = !1 !== a && !J,
            ...
            D = (n._enterCb = P(function() {
              N && (Dr(n, j), Dr(n, E)),
                D.cancelled ? (N && Dr(n, S), L && L(n)) : R && R(n),
                (n._enterCb = null);
            }));
          t.data.show ||
            ...
            N &&
              ...
              Nr(function() {
                Dr(n, S),
                  D.cancelled ||
                    (Ur(n, j), U || (Kr(M) ? setTimeout(D, M) : qr(n, s, D)));
              })),
      ...
      if (!i(n._leaveCb)) {
        ...
        var x = (n._leaveCb = P(function() {
          n.parentNode &&
            ...
            _ && (Dr(n, f), Dr(n, l)),
            x.cancelled ? (_ && Dr(n, u), m && m(n)) : (e(), v && v(n)),
            (n._leaveCb = null);
        }));
        y ? y(C) : C();
      }
        ...
        x.cancelled ||
          ...
          _ &&
            ...
            Nr(function() {
              Dr(n, u),
                x.cancelled ||
                  (Ur(n, f), b || (Kr(w) ? setTimeout(x, w) : qr(n, s, x)));
            })),
          d && d(n, x),
          _ || b || x());
      }
          ...
          if (o(t)) (p = !0), l(e, d, c, f);
            ...
            if (!h && Fn(t, e)) A(t, e, d, s);
              ...
              var v = t.elm,
                y = u.parentNode(v);
              if (
                (l(e, d, v._leaveCb ? null : y, u.nextSibling(v)), i(e.parent))
              )
    ...
    var qo,
      ...
      Fo = {
        ...
        render: function(t) {
          ...
          var m = function(t) {
              Ho(t) && (e.replace ? n.replace(i) : n.push(i));
            },
            y = { click: Ho };
    ...
    function zo(t) {
      if (!zo.installed || qo !== t) {
        ...
        t.mixin({
          ...
          t.component("router-view", ko),
          t.component("router-link", Fo);
    ...
    function di(t, e, n) {
      try {
        return (pi[t] || (pi[t] = Jo.compile(t)))(e || {}, { pretty: !0 });
      } catch (t) {
        return "";
      }
    }
      ...
      if (n && "string" == typeof t.selector) {
        ...
        if (r) {
          ...
          e = (function(t, e) {
            ...
            r,
            (o = (function(t) {
              return { x: ki(t.x) ? t.x : 0, y: ki(t.y) ? t.y : 0 };
            })(o))
          );
        } else Ci(t) && (e = Ai(t));
      } else n && Ci(t) && (e = Ai(t));
            ...
            var c,
              u = Di(function(e) {
                (function(t) {
                  ...
                  (t.resolved = "function" == typeof e ? e : qo.extend(e)),
                  (n.components[s] = e),
                  --i <= 0 && r();
              }),
              f = Di(function(t) {
    ...
    function Bi(t, e, n, r) {
      var o = Mi(t, function(t, r, o, i) {
        var a = (function(t, e) {
          "function" != typeof t && (t = qo.extend(t));
          return t.options[e];
        })(t, e);
        if (a)
    ...
    (qi.prototype.listen = function(t) {
      this.cb = t;
    }),
      ...
      (qi.prototype.transitionTo = function(t, e, n) {
        var r = this,
      ...
      (qi.prototype.confirmTransition = function(t, e, n) {
        var r = this,
          o = this.current,
          i = function(t) {
            Ao(t) &&
        ...
        var a = (function(t, e) {
          ...
          f = [].concat(
            (function(t) {
              return Bi(t, "beforeRouteLeave", Vi, !0);
            })(c),
            this.router.beforeHooks,
            (function(t) {
              return Bi(t, "beforeRouteUpdate", Vi);
            })(s),
            u.map(function(t) {
      ...
      (qi.prototype.updateRoute = function(t) {
        var e = this.current;
        (this.current = t),
          this.cb && this.cb(t),
    ...
    var Fi = (function(t) {
      ...
      return (
        ...
        (e.prototype.ensureURL = function(t) {
          if (Hi(this.base) !== this.current.fullPath) {
      ...
      return (
        ...
        (e.prototype.setupListeners = function() {
          var t = this,
            ...
            n = Oi && e;
          n && bi(),
            window.addEventListener(Oi ? "popstate" : "hashchange", function() {
              var e = t.current;
              Wi() &&
                t.transitionTo(Ki(), function(r) {
                  n && wi(t.router, r, e, !0), Oi || Ji(r.fullPath);
                });
            });
        }),
        (e.prototype.push = function(t, e, n) {
    ...
    var Qi = (function(t) {
      ...
      Yi = function(t) {
        ...
        var e = t.mode || "hash";
        switch (
          ((this.fallback = "history" === e && !Oi && !1 !== t.fallback),
          ...
          case "history":
            this.history = new Fi(this, t.base);
            break;
          case "hash":
    ...
    (Yi.prototype.match = function(t, e, n) {
      ...
      (Yi.prototype.init = function(t) {
        ...
        if ((this.apps.push(t), !this.app)) {
          this.app = t;
          var n = this.history;
          if (n instanceof Fi) n.transitionTo(n.getCurrentLocation());
    ...
    var oa = _o(
      ...
      function() {
        var t = this,
          e = t.$createElement;
        return (t._self._c || e)("div", { staticClass: "tmn-container" }, [
          t._ssrNode(
    ...
    e.default = function(t) {
      return new Promise(function(e, n) {
        ...
        i.push(t),
          i.onReady(function() {
            i.getMatchedComponents().length || n({ code: 404 }), e(o);
          }, n);
      });
    };
  }
